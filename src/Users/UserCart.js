...
import { logout, updateCartToOrder, updateLineItem } from '../store';

const UserCart = ({ auth, lineItems, cart, subtotal, increment, updateCartToOrder, deleteLineItem }) => {
...
const mapDispatch = (dispatch) => {
  return {
    ...
    updateCartToOrder: (cart) => {
      dispatch(updateCartToOrder(cart))
    }
  };
};
